...
* `zabbix_server_url`: This is the url on which the zabbix web interface is available. Default is zabbix.example.com, you should override it. For example, see "Example Playbook"
...
Including an example of how to use your role (for instance, with variables passed in as parameters) is always nice for users too:
    ...
    - hosts: zabbix-server
      ...
      roles:
         ...
         - { role: dj-wasabi.zabbix-server, zabbix_server_url: zabbix.dj-wasabi.nl, database_type: mysql, database_type_long: mysql }
