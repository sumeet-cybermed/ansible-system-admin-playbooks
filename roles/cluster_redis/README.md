...
``` bash
$ ansible-galaxy install cluster_redis
```
...
``` yml
redis_slaveof: "{{ hostvars['redis-master.example.com'].ansible_eth1.ipv4.address }} {{ redis_listen_port }}"
```
...
redis_working_dir: /var/lib/redis/{{ redis_listen_port }}
redis_tarball: false
...
redis_listen_address: 0.0.0.0
redis_listen_port: 6379
redis_auth_password: false
