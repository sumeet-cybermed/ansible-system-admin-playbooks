...
| `rocket_chat_mongodb_config_template` | [`mongod.conf`](templates/mongod.conf) | The `/etc/mongod.conf` template to deploy |
...
| `  src` | `rocketchat.service` | The source template to deploy for the Rocket.Chat service manifest |
...
| `rocket_chat_service_template` | | |
| `  src` | `rocketchat_upstart` | The source template to deploy for the Rocket.Chat service manifest |
